  ...
  <div class="perfil">
    <div class="col-md-10">
      ...
      ?>
        ...
        {{-- Foto usuario --}}
        <div class=""><img class="rounded-circle" style="width: 200px; height: 200px;" src="{{ 'http://localhost/bizsett/public/storage/fotos_perfiles/' . $user['foto_perfil']}}" alt="user" ></div>
